...
public class MetierCatalogue {
	...
	public static Catalogue getCatalogue() {
		if (catalogue == null) {
			...
			livre1.setResume(
					"Une nouvelle série permettant à de grands dessinateurs d'explorer le vaste univers de Troy... Nicolas Keramidas ouvre le bal.");
			...
			livre2.setResume(
					"Grâce au kama-sutra magique... passez une Saint Valentin pimentée ! (Bon, nous en magasin...)");
			...
			livre3.setResume("Steve Berry au meilleur de sa forme pour son grand retour. Quand trembler fait du");
			...
			livre4.setResume("Le destin existe, mais il n'est pas responsable de tout. On peut l'améliorer.");
			...
			livre5.setResume("Un grand livre sur le mensonge paternel, par John Burnside, l'éblouissant");
